...
export interface AISuggestTraitsRequest {
  race: string
  class: string
  background: string
  alignment?: string
...
export interface AISuggestTraitsResponse {
  success: boolean
  traits?: string[]
  error?: string
}

export interface AIRecommendStatsRequest {
  class: string
  race?: string
}

export interface AIRecommendStatsResponse {
  success: boolean
  recommendedStats?: {
    strength: number
    dexterity: number
